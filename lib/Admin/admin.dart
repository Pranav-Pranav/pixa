...
class _AdminState extends State<Admin> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> pages=[Home(),Add(),Settings(),Account()];
        ...
        child: Scaffold(
          ...
          body: Row(
            children: [
              NavigationRail(
                groupAlignment: .9,
                trailing: CircleAvatar(backgroundImage: AssetImage('assets/asmin.png')),
                ...
                destinations: [
                  ...
                  NavigationRailDestination(
                      icon: SizedBox.shrink(),
                      label: RotatedBox(quarterTurns: 3,child:Text("Add"))),
                  NavigationRailDestination(
                      icon: SizedBox.shrink(),
        ...
        SizedBox(height: MediaQuery.of(context).size.height-150,child:TabBarView(
          children: [
            ValueListenableBuilder(
                ...
                builder: (context,dummyBoksValueNotifier,_){return Available(books: dummyBoks);}),
            ValueListenableBuilder(
                valueListenable: dummyBoksValueNotifier,
                builder: (context,dummyBoksValueNotifier,_){return All(books: dummyBoks);}),
            Issued(books:context.watch<BookServices>().books)
          ],
        ))
      ],
    );
