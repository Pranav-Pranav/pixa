...
class All extends StatefulWidget {
  ...
  All({required this.books});
  @override
  State<All> createState() => _AllState(books: books);
}

class _AllState extends State<All> {
  @override List<Map<String,dynamic>>books;
  _AllState({required this.books});

  Widget build(BuildContext context) {
    return Scaffold(
        body:
        ListView(
          children: books.map((book) => BookTile(book: book)).toList(),
        ));
  }
}
